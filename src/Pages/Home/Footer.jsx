      ...
      <div className="footer--link--container">
        ...
        <div className="footer--social--icon">
          <ul>
            ...
            <li>
              <a
                href="https://www.instagram.com/zohaib_hassan04"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/zohaib-hassan-b62a432b1/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a target="_blank" href="https://github.com/zohaibhassan04">
                <FaGithubSquare color="black" size={28} />
              </a>
            </li>
          </ul>
          <a href="https://mail.google.com/mail/?view=cm&fs=1&to=ssc.zohaib.190047@gmail.com" target="_blank" className="mail">ssc.zohaib.190047@gmail.com</a>

        </div>
      </div>
      <hr className="divider" />
      <div className="footer--content--container">
        <p className="footer--content">Made with 💖 by Zohaib</p>
        {/* <div className="footer--social--icon">
          <ul>
            <li>
              <Link
